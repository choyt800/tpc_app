...
class MembershipsControllerTest < ActionController::TestCase
  ...
  test "should create membership" do
    assert_difference('Membership.count') do
      post :create, membership: { datetime: @membership.datetime, start_date: @membership.start_date, type: @membership.type }
    end
  ...
  test "should update membership" do
    patch :update, id: @membership, membership: { datetime: @membership.datetime, start_date: @membership.start_date, type: @membership.type }
    assert_redirected_to membership_path(assigns(:membership))
  end
